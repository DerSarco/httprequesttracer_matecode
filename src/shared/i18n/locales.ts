...
export const LOCALES: Record<Language, LocaleTexts> = {
  es: {
    ...
    statusDetailsTitle: "Detalles de entorno y sesion",
    statusDetailsSummary: "{adbLabel}: {adbValue} · {emulatorsLabel}: {emulatorsCount} · {sessionLabel}: {sessionValue}",
    statusDetailsShow: "Ver detalles",
    statusDetailsHide: "Ocultar detalles",
    yes: "Si",
    no: "No",
    ...
    donationDialogTitle: "Antes de ir a PayPal",
    donationDialogBody: "La donacion es totalmente opcional. Si quieres apoyar el proyecto, te llevaremos a PayPal en el navegador.",
    donationDialogFundingNote:
      "El aporte ayuda a pagar el Apple Developer Program y avanzar hacia una app firmada para macOS.",
    donationDialogCancel: "Cancelar",
    donationDialogConfirm: "Continuar a PayPal",
    copyUrl: "Copiar URL",
  ...
  en: {
    ...
    statusDetailsTitle: "Environment and session details",
    statusDetailsSummary: "{adbLabel}: {adbValue} · {emulatorsLabel}: {emulatorsCount} · {sessionLabel}: {sessionValue}",
    statusDetailsShow: "View details",
    statusDetailsHide: "Hide details",
    yes: "Yes",
    no: "No",
    ...
    donationDialogTitle: "Before opening PayPal",
    donationDialogBody: "Donating is completely optional. If you want to support the project, we will open PayPal in your browser.",
    donationDialogFundingNote:
      "Your contribution helps cover the Apple Developer Program and move toward a signed macOS app.",
    donationDialogCancel: "Cancel",
    donationDialogConfirm: "Continue to PayPal",
    copyUrl: "Copy URL",
